package com.social.sign.in.horizontalprogresspar;
...
public class HorizontalProgressBar extends ProgressBar {
    ...
    private void setUpStyleable(Context context, AttributeSet attrs) {
        ...
        mBackgroundColor = typedArray.getColor(R.styleable.HorizontalProgress_backgroundColor, Color.GRAY);
        mProgressColor = typedArray.getColor(R.styleable.HorizontalProgress_progressColor, Color.BLUE);
        mIsRounded = typedArray.getBoolean(R.styleable.HorizontalProgress_isRounded, true);
